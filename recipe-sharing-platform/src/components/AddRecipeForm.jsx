...
const AddRecipeForm = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:px-8">
      <h1 className="text-3xl font-bold text-center mb-6 md:text-4xl">Add New Recipe</h1>
      <form
        onSubmit={handleSubmit}
        className="max-w-lg mx-auto bg-white shadow-lg rounded-lg p-6 md:max-w-xl"
      >
        <div className="mb-4">
          <label
            htmlFor="title"
        ...
        <button
          type="submit"
          className="w-full bg-indigo-500 text-white px-4 py-2 rounded-lg hover:bg-indigo-600 transition duration-200 md:px-6"
        >
          Submit Recipe
        </button>
      </form>
